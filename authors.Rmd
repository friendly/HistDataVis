...
<td>
Michael Friendly is a Professor of Psychology, founding chair of the <a href="http://qm.info.yorku.ca/">Graduate Program in Quantitative Methods</a>, and an associate coordinator with the <a href="http://www.yorku.ca/isr/scs/">Statistical Consulting Service</a> at York University. He earned a PhD in psychology from Princeton University, specializing in psychometrics and cognitive psychology.

His main research areas are the development of graphical methods for categorical and multivariate data and the history of data visualization. He is the author of five other books, most recently, *Discrete Data Analysis with R: Visualization and Modeling Techniques for Categorical and Count Data* (2015).  He is a	fellow of the American Statistical Association, associate editor of the *Journal of Computational and Graphical Statistics* and *Statistical Science*. 
</td></tr></table>
...
(2009), and *Truth or Truthiness: Distinguishing Fact from Fiction by Learning to Think like a Data Scientist* (2016).
</td></tr></table>
