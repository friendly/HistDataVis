...
This is a topic that has long concerned us. Almost surely some of the graphical inventions we describe had some other and perhaps earlier form in non-Western cultures. We have seen many wonderful examples.  Celestial graphic representations--- positions of stars and planets -- go back thousands of years, and we find one particularly lovely example in the Dunhung Star Chart (7th Century)[^1] , the world’s oldest star catalog.

[^1]: Dunhung Star Chart, https://en.wikipedia.org/wiki/Dunhuang_Star_Chart

Systematic data tabulation is easily traced to early Egyptian recordings of levels of the Nile as a solution to problems caused by periodic flooding[^2]. We find that early geographical maps were developed independently in China around 227 BCE[^3], the first mention we could find.  One can also trace the development of coordinate systems to music notation around the 9th Century  which used a horizontal axis to represent time and the vertical axis for pitch.

[^2]: W. Popper, _The Cairo Nilometer: Studies in Ibn Taghri Birdi’s Chronicles of Egypt_: I, no. v. 12. University of California Press, 1951.
[^3]: https://www.viewofchina.com/ancient-chinese-maps/
[^4]: https://en.wikipedia.org/wiki/Musical_notation 
